...
var script = {
  ...
  methods: {
    initAxisDaysAndHours: function initAxisDaysAndHours() {
      this.axisDays = [];
      var start = hooks(this.chartStart);
      var end = hooks(this.chartEnd);
    ...
    getAxisDayObject: function getAxisDayObject(datetime, widthPercentage, endHour) {
      var datetimeMoment = hooks(datetime);
      var axisDayObject = {
    ...
    dayFormatted: function dayFormatted(day) {
      ...
      return day.widthPercentage >= 12 ? hooks(day.value).locale(this.locale).format(this.dayFormat) : "";
    }
  },
  watch: {
...
var __vue_inject_styles__ = function __vue_inject_styles__(inject) {
  if (!inject) return;
  inject("data-v-f2c098d0_0", {
    source: "#g-timeaxis[data-v-f2c098d0],.g-timeaxis-day[data-v-f2c098d0],.g-timeaxis-day>div[data-v-f2c098d0],.g-timeaxis-days[data-v-f2c098d0]{display:flex;overflow:hidden}#g-timeaxis[data-v-f2c098d0]{position:sticky;top:0;width:100%;height:8%;min-height:75px;background:#fff;z-index:4;box-shadow:0 1px 3px 2px rgba(50,50,50,.5)}#g-timeaxis>.g-timeaxis-empty-space[data-v-f2c098d0]{width:20%;height:100%;background:#f5f5f5}#g-timeaxis>.g-timeaxis-days[data-v-f2c098d0]{position:relative;width:80%;height:100%,}.g-timeaxis-day[data-v-f2c098d0]{height:100%;flex-direction:column;background:#e0e0e0}.g-timeaxis-day[data-v-f2c098d0]:nth-child(odd){background:#e8e8e8}.g-timeaxis-day>div[data-v-f2c098d0]:nth-child(1){height:50%;justify-content:space-around;font-weight:700;align-items:center}.g-timeaxis-day>div[data-v-f2c098d0]:nth-child(2){align-items:flex-end;height:50%;justify-content:space-between;background:#f5f5f5;padding-top:2px;color:#212121}.g-timeaxis-hour[data-v-f2c098d0]{display:flex;justify-content:space-between;align-items:flex-start;flex-direction:column;opacity:.5;width:100%}.g-timeaxis-hour-pin[data-v-f2c098d0]{width:1px;height:8px}#g-timeaxis-marker[data-v-f2c098d0]{position:absolute;top:0;left:0;height:100%;width:3px;background:#000}",
    map: undefined,
    media: undefined
  });
};
...
var __vue_scope_id__ = "data-v-f2c098d0";
/* module identifier */
...
var script$1 = {
  ...
  computed: {
    allHours: function allHours() {
      var momentChartStart = hooks(this.chartStart);
      var momentChartEnd = hooks(this.chartEnd);
      var res = [];
...
var __vue_inject_styles__$1 = function __vue_inject_styles__(inject) {
  if (!inject) return;
  inject("data-v-051e1f31_0", {
    source: ".g-grid-container[data-v-051e1f31]{position:absolute;top:0;left:30%;width:70%;height:calc(100% - 23px);display:flex;justify-content:space-between}.g-grid-line[data-v-051e1f31]{width:1px;height:100%;background:#eaeaea}.g-grid-line-highlighted[data-v-051e1f31]{background:#90caf9;box-shadow:0 0 0 1px #90caf9}",
    map: undefined,
    media: undefined
  });
};
...
var __vue_scope_id__$1 = "data-v-051e1f31";
/* module identifier */
...
var script$2 = {
  ...
  inject: ["getHourCount", "ganttChartProps", "initDragOfBarsFromBundle", "moveBarsFromBundleOfPushedBar", "setDragLimitsOfGanttBar", "onBarEvent", "onDragendBar"],
  data: function data() {
    return {
      showTooltip: false,
      tooltipTimeout: null,
  ...
  computed: {
    ...
    barStartMoment: {
      get: function get() {
        return hooks(this.bar[this.barStart]);
      },
      set: function set(value) {
        this.bar[this.barStart] = hooks(value).format("YYYY-MM-DD HH:mm:ss");
      }
    },
    barEndMoment: {
      get: function get() {
        return hooks(this.bar[this.barEnd]);
      },
      set: function set(value) {
        this.bar[this.barEnd] = hooks(value).format("YYYY-MM-DD HH:mm:ss");
      }
    },
    ...
    barStyle: function barStyle() {
      ...
      return Object.assign({}, this.barConfig || {}, {
    ...
    chartStartMoment: function chartStartMoment() {
      return hooks(this.ganttChartProps.chartStart);
    },
    chartEndMoment: function chartEndMoment() {
      return hooks(this.ganttChartProps.chartEnd);
    }
  },
  methods: {
    ...
    drag: function drag(e) {
      ...
      this.onBarEvent(Object.assign({}, e, {
        type: "drag"
      }), this);
    },
    ...
    manageOverlapping: function manageOverlapping() {
      ...
      while (overlapBar) {
        ...
        var currentStartMoment = hooks(currentBar[this.barStart]);
        var currentEndMoment = hooks(currentBar[this.barEnd]);
        var overlapStartMoment = hooks(overlapBar[this.barStart]);
        var overlapEndMoment = hooks(overlapBar[this.barEnd]);
    ...
    getOverlapBarAndType: function getOverlapBarAndType(bar) {
      ...
      var barStartMoment = hooks(bar[this.barStart]);
      var barEndMoment = hooks(bar[this.barEnd]);
      ...
      var overlapBar = this.allBarsInRow.find(function (otherBar) {
        ...
        var otherBarStart = hooks(otherBar[_this2.barStart]);
        var otherBarEnd = hooks(otherBar[_this2.barEnd]);
    ...
    moveBarByMinutesAndPush: function moveBarByMinutesAndPush(minuteCount, direction) {
      switch (direction) {
        case "left":
          this.barStartMoment = hooks(this.barStartMoment).subtract(minuteCount, "minutes", true);
          this.barEndMoment = hooks(this.barEndMoment).subtract(minuteCount, "minutes", true);
          break;

        case "right":
          this.barStartMoment = hooks(this.barStartMoment).add(minuteCount, "minutes", true);
          this.barEndMoment = hooks(this.barEndMoment).add(minuteCount, "minutes", true);
          break;
    ...
    mapTimeToPosition: function mapTimeToPosition(time) {
      var hourDiffFromStart = hooks(time).diff(this.chartStartMoment, "hour", true);
  ...
  filters: {
    TimeFilter: function TimeFilter(value) {
      return hooks(value).format("HH:mm");
    }
  }
};
...
var __vue_render__$2 = function __vue_render__() {
  ...
  }, [_vm.showTooltip || _vm.isDragging ? _c('div', {
...
var __vue_inject_styles__$2 = function __vue_inject_styles__(inject) {
  if (!inject) return;
  inject("data-v-dff597a4_0", {
    source: ".g-gantt-bar[data-v-dff597a4]{position:absolute;top:2px;left:30px;display:flex;justify-content:space-between;align-items:center;color:#fff;width:300px;height:34px;border-radius:15px;background:#79869c;overflow:hidden}.g-gantt-bar-label[data-v-dff597a4]{width:100%;height:100%;box-sizing:border-box;padding:0 14px 0 14px;display:flex;justify-content:center;align-items:center}.g-gantt-bar-label>*[data-v-dff597a4]{white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.g-gantt-bar>.g-gantt-bar-handle-left[data-v-dff597a4],.g-gantt-bar>.g-gantt-bar-handle-right[data-v-dff597a4]{position:absolute;width:10px;height:100%;background:#fff;opacity:.7;border-radius:40px;cursor:w-resize}.g-gantt-bar-handle-left[data-v-dff597a4]{left:0}.g-gantt-bar-handle-right[data-v-dff597a4]{right:0}.g-gantt-bar-label img[data-v-dff597a4]{pointer-events:none}.g-gantt-tooltip[data-v-dff597a4]{position:absolute;background:#000;color:#fff;z-index:3;font-size:.7em;padding:3px;border-radius:3px;transition:opacity .2s;display:flex;align-items:center}.g-gantt-tooltip[data-v-dff597a4]:before{content:'';position:absolute;top:0;left:10%;width:0;height:0;border:10px solid transparent;border-bottom-color:#000;border-top:0;margin-left:-5px;margin-top:-5px}.g-gantt-tooltip>.color-indicator[data-v-dff597a4]{width:8px;height:8px;border-radius:100%;margin-right:4px}.fade-enter-active[data-v-dff597a4]{animation:fade-in-data-v-dff597a4 .3s}.fade-leave-active[data-v-dff597a4]{animation:fade-in-data-v-dff597a4 .3s reverse}@keyframes fade-in-data-v-dff597a4{from{opacity:0}to{opacity:1}}",
    map: undefined,
    media: undefined
  });
};
...
var __vue_scope_id__$2 = "data-v-dff597a4";
/* module identifier */
...
var __vue_inject_styles__$3 = function __vue_inject_styles__(inject) {
  if (!inject) return;
  inject("data-v-05bb1f0c_0", {
    source: ".g-gantt-row[data-v-05bb1f0c]{display:flex;width:100%;height:40px;transition:background-color .2s}.g-gantt-row>.g-gantt-row-label[data-v-05bb1f0c]{display:flex;justify-content:center;align-items:center;width:20%;background:#e8e8e8;color:#424242;font-size:.9em;z-index:3;overflow:hidden;font-weight:700}.g-gantt-row>.g-gantt-row-bars-container[data-v-05bb1f0c]{position:relative;border-top:1px solid #eaeaea;width:70%;border-bottom:1px solid #eaeaea}",
    map: undefined,
    media: undefined
  });
};
...
var __vue_scope_id__$3 = "data-v-05bb1f0c";
/* module identifier */
...
var script$4 = {
  ...
  props: {
    chartStart: {
      type: String,
      "default": hooks().startOf("day").format("YYYY-MM-DD HH:mm:ss")
    },
    chartEnd: {
      type: String,
      "default": hooks().startOf("day").add(12, "hours").format("YYYY-MM-DD HH:mm:ss")
    },
  ...
  computed: {
    ...
    ganttBarChildrenList: function ganttBarChildrenList() {
  ...
  methods: {
    getBarsFromBundle: function getBarsFromBundle(bundleId) {
      ...
      return this.ganttBarChildrenList.filter(function (ganttBarChild) {
    ...
    setDragLimitsOfGanttBar: function setDragLimitsOfGanttBar(bar) {
      ...
      var _loop = function _loop() {
        ...
        var _this4$countGapDistan = _this4.countGapDistanceToNextImmobileBar(bar, 0, side),
...
var __vue_inject_styles__$4 = function __vue_inject_styles__(inject) {
  if (!inject) return;
  inject("data-v-581a90bb_0", {
    source: "#g-gantt-chart[data-v-581a90bb]{position:relative;display:flex;flex-direction:column;overflow-x:hidden;-webkit-touch-callout:none;-webkit-user-select:none;-khtml-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;padding-bottom:23px}#g-gantt-chart[data-v-581a90bb] *{font-family:Roboto,Verdana}#g-gantt-rows-container[data-v-581a90bb]{position:relative}",
    map: undefined,
    media: undefined
  });
};
...
var __vue_scope_id__$4 = "data-v-581a90bb";
/* module identifier */
